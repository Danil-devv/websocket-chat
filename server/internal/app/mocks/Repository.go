...
func (_m *Repository) LoadMessages(ctx context.Context, count int) ([]domain.Message, error) {
...
func (_m *Repository) SaveMessage(ctx context.Context, message domain.Message) error {
